  ...
  <div class="col-sm-12 col-12 col-lg-9">
      ...
      <div class="col-lg-3 justify-content-right float-right">
        <div class="button " id="add_catagory">
          <button><a  href="{{url('dashboard/website/history/CompanyHistory')}}">all  information </a></button>
        </div>
      </div>
...
<section>
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-10">
        <div class="froms">
        <form action="{{url('dashboard/website/history/CompanyHistory/submit')}}" method="post" enctype="multipart/form-data">
          @csrf
          <!-- start  -->
