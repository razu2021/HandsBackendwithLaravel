  ...
  <div class="col-sm-12 col-12 col-lg-9">
      ...
      <div class="col-lg-3 justify-content-right float-right">
        <div class="button " id="add_catagory">
          <button><a  href="{{url('dashboard/website/volunteer/VolunteerManagementTeam')}}">all  information </a></button>
        </div>
      </div>
...
<section>
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-10">
        <div class="froms">
        <form action="{{url('dashboard/website/volunteer/VolunteerManagementTeam/submit')}}" method="post" enctype="multipart/form-data">
          @csrf
          <!-- start  -->
        ...
        <!--  group  end here  -->
        <div class="form-group">
          <label id="label_content" for="exampleInputEmail1">Add Title   <span class="text-danger"> * </span></label>
        ...
        <!--  group  end here  -->
        <div class="form-group">
          <label id="label_content" for="exampleInputEmail1">Add Subtitlle   <span class="text-danger"> * </span></label>
          <input type="text" class="form-control"  name="subtitle" value = "" placeholder="Donner name ">
        </div> 
        <!--  group  end here  -->
          <div class="form-group">
