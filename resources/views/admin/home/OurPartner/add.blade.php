...
<section>
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-10">
        <div class="froms">
        <form action="{{url('dashboard/website/home/OurPartner/submit')}}" method="post" enctype="multipart/form-data">
          @csrf
          <!-- start  -->
        ...
        <!--  group  end here  -->
          <div class="form-group">
          <label id="label_content" for="exampleInputEmail1">OurPartner Info   <span class="text-danger"> * </span></label>
