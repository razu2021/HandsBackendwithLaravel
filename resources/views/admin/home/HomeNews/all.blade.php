                ...
                <div class="row ">
                  ...
                  <div class="col-lg-2 justify-content-right float-right">
                    ...
                    <div class="button " id="add_catagory">
                      <a href="{{url('dashboard/website/home/HomeNews/recycle')}}" style="color:red; font-size:25px;background:#fff;padding:2px;border-radius:8px"><span><i class="bi bi-trash3"></i></span></a>
                      <button><a  href="{{url('dashboard/website/home/HomeNews/add')}}">Add Information</a></button>
                    </div>
                  </div>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                  <ul>
                                                    <li class="nav-item" style="font-size:16px;text-transform:capitalize;padding:10px 8px;border-bottom:1px solid #000;">
                                                      <a class="nav-link " href="{{url('dashboard/website/home/HomeNews/view/'.$data->slug)}}">view</a>
                                                  </li>
                                                    <li class="nav-item" style="font-size:16px;text-transform:capitalize;padding:10px 8px;border-bottom:1px solid #000;">
                                                      <a class="nav-link" href="{{url('dashboard/website/home/HomeNews/edit/'.$data->slug)}}" >Edit</a>
                                                  </li>
                                                    <li class="nav-item" style="font-size:16px;text-transform:capitalize;padding:10px 8px;border-bottom:1px solid #000;">
                                                        <a class="nav-link" onclick="return confirm('Are Your Deleted this Information')" href="{{url('dashboard/website/home/HomeNews/softdelete/'.$data->HEvent_id)}}" >Delete</a>
                                                  </li>
                                                  </ul>
                                                </div>
                                              </div>
