...
<section>
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-10">
        <div class="froms">
        <form action="{{url('dashboard/website/home/HomeNews/submit')}}" method="post" enctype="multipart/form-data">
          @csrf
          <!-- start  -->
        <div class="form-group">
          <label id="label_content" for="exampleInputEmail1">Add news Heading   <span class="text-danger"> * </span></label>
