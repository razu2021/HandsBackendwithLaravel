                                    ...
                                    <table class="table bg-white  table-striped  ">
                                        ...
                                        <tbody class="p-2">
                                          @foreach($all as $data)
                                                ...
                                                <td>{{$data->phone}}</td>
                                                <td>{{$data->email}}</td>
                                                <td>{!!Str::words($data->massage,10)!!}</td>
                                                <td>
                                                <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">                       
                                                  <ul>
                                                    <li class="nav-item" style="font-size:16px;text-transform:capitalize;padding:10px 8px;border-bottom:1px solid #000;">
                                                        <a class="nav-link" onclick="return confirm('Are Your Restore  this Information Right Now ! ')" href="{{url('dashboard/website/contact/ContactMassage/restore/'.$data->HEvent_id)}}" >restore</a>
                                                  </li>
                                                    <li class="nav-item" style="font-size:16px;text-transform:capitalize;padding:10px 8px;border-bottom:1px solid #000;">
                                                        <a class="nav-link" onclick="return confirm('Are Your Delete  this Information Right Now ! ')" href="{{url('dashboard/website/contact/ContactMassage/delete/'.$data->HEvent_id)}}" >Delete</a>
                                                  </li>
                                                  </ul>                                                                                                      
                                                </div>
                                              </div>
