                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                  <ul>
                                                    <li class="nav-item" style="font-size:16px;text-transform:capitalize;padding:10px 8px;border-bottom:1px solid #000;">
                                                        <a class="nav-link" onclick="return confirm('Are Your Restore  this Information Right Now ! ')" href="{{url('dashboard/website/manage/TeamSocial/restore/'.$data->HEvent_id)}}" >restore</a>
                                                  </li>
                                                    <li class="nav-item" style="font-size:16px;text-transform:capitalize;padding:10px 8px;border-bottom:1px solid #000;">
                                                        <a class="nav-link" onclick="return confirm('Are Your Delete  this Information Right Now ! ')" href="{{url('dashboard/website/manage/TeamSocial/delete/'.$data->HEvent_id)}}" >Delete</a>
                                                  </li>
                                                  </ul>
                                                </div>
                                              </div>
